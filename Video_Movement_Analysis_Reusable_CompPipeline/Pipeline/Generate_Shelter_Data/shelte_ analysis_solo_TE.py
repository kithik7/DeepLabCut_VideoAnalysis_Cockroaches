#!/bin/bash
#SBATCH --job-name=zone_analysis_all_frames
#SBATCH --output=zone_analysis_all_frames.out
#SBATCH --error=zone_analysis_all_frames.err
...
def analyze_video_zone_preference(csv_file, fps=2.0, total_video_length=600.5):
    try:
    ...
    if not csv_file:
        ...
        if analysis:
            ...
            result = {
                ...
                'total_video_time': analysis['total_video_time'],
...
output_file = 'shelter_preference_all_frames.csv'
